...
echo -e ""
echo -e "${INFO}${YW}Provider CLIs are installed but not authenticated. Log in from the host:${CL}"
...
echo -e ""
echo -e "${INFO}${YW}Source-control CLIs are installed but not authenticated. Log in from the host:${CL}"
echo -e "${TAB}${BGN}pct exec ${CTID} -- gh auth login${CL}"
echo -e "${TAB}${BGN}pct exec ${CTID} -- glab auth login${CL}"
echo -e "${TAB}${BGN}pct exec ${CTID} -- az login${CL}"
