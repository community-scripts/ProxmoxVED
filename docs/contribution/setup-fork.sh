...
# upstream   https://github.com/GoldenSpringness/ProxmoxVED.git (fetch)
# upstream   https://github.com/GoldenSpringness/ProxmoxVED.git (push)
```
...
print_info "Upstream: https://github.com/GoldenSpringness/ProxmoxVED"
echo ""
