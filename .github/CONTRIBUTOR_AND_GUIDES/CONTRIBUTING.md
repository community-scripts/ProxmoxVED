...
`export BASE_URL=https://raw.githubusercontent.com/YOUR_USERNAME/YOUR_FORK_NAME/TARGET_COMMIT_HASH && bash -c "$(curl -fsSL "$BASE_URL"/ct/AppName.sh)"`

or

`export BASE_URL=https://raw.githubusercontent.com/YOUR_USERNAME/YOUR_FORK_NAME/YOUR_BRANCH_NAME && bash -c "$(curl -fsSL "$BASE_URL"/ct/AppName.sh)"`
