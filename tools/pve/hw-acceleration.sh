...
# Repo: https://github.com/community-unscripted/ProxmoxVED
#
# Usage: bash -c "$(wget -qLO - https://github.com/community-unscripted/ProxmoxVED/raw/main/misc/hw-acceleration.sh)"
#
# Requires:
#   - Proxmox VE 8.1+
...
# https://github.com/community-unscripted/ProxmoxVED
...
source <(wget -qO- https://github.com/community-unscripted/ProxmoxVED/raw/main/tools/pve/gpu-nvidia.func)
source <(wget -qO- https://github.com/community-unscripted/ProxmoxVED/raw/main/tools/pve/gpu-intel.func)
source <(wget -qO- https://github.com/community-unscripted/ProxmoxVED/raw/main/tools/pve/gpu-amd.func)
