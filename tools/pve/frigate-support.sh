...
# License: MIT
# https://github.com/GoldenSpringness/ProxmoxVED/raw/main/LICENSE
...
# bash -c "$(curl -fsSL https://github.com/GoldenSpringness/ProxmoxVED/raw/main/misc/frigate-support.sh)"
