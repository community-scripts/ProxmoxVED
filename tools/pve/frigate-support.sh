...
# License: MIT
# https://github.com/community-unscripted/ProxmoxVED/raw/main/LICENSE
...
# bash -c "$(curl -fsSL https://github.com/community-unscripted/ProxmoxVED/raw/main/misc/frigate-support.sh)"
