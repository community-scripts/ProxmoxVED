...
declare -f init_tool_telemetry &>/dev/null && init_tool_telemetry "proxmorph" "addon"
...
function header_info {
  ...
  cat <<"EOF"
    ____                  __  ___                 __  
   / __ \_________  _  __/  |/  /___  _________  / /_ 
  / /_/ / ___/ __ \| |/_/ /|_/ / __ \/ ___/ __ \/ __ \
 / ____/ /  / /_/ />  </ /  / / /_/ / /  / /_/ / / / /
/_/   /_/   \____/_/|_/_/  /_/\____/_/  / .___/_/ /_/ 
                                       /_/            
...
# ==============================================================================
function uninstall() {
  msg_info "Uninstalling ProxMorph"
...
# ==============================================================================
function install() {
  msg_info "Preparing ProxMorph installation"
...
UPDATEEOF
  ...
  echo ""
  msg_ok "ProxMorph installed successfully"
