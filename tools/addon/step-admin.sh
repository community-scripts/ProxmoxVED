...
# Source: https://smallstep.com/ | Github: https://github.com/smallstep
...
source <(curl -fsSL https://raw.githubusercontent.com/community-scripts/ProxmoxVED/main/misc/admin-core.func)
source <(curl -fsSL https://raw.githubusercontent.com/community-scripts/ProxmoxVED/main/misc/whiptail.func)
